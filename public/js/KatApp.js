    ...
    */
    ...
    $.fn.KatApp.applicationFactory = $.fn.KatApp.debugApplicationFactory = function (id, element, options) {
        ...
        if (applications.length === 1) {
            ...
            shim.trace("Downloading KatAppProvider.js from " + (debugProviderDomain !== null && debugProviderDomain !== void 0 ? debugProviderDomain : shim.options.functionUrl), TraceVerbosity.Diagnostic);
